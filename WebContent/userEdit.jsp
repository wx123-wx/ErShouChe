...
<aside class="lt_aside_nav content mCustomScrollbar">
 ...
 <ul>
  ...
  <li>
   <dl>
    <dt>用户管理</dt>
    <dd><a href="order_list.html">所有用户</a></dd>
...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
     ...
     <section>
     <form method="post"  action="UserServlet?method=update"  enctype="multipart/form-data">
     <input type="hidden"  name="userid"    value="<%=((User)request.getAttribute("user")).getUserid() %>"  />
      <ul class="ulColumn2">
       <li>
        ...
        <img src="<%=((User)request.getAttribute("user")).getZhaopian()  %>" style="width: 80px;height: 80px;border:1px solid black;position: relative;top: -20px" />
       </li>
       <li>
        <span class="item_name" style="width:120px;">姓名：</span>
        <input type="text"  name="xingming"  value="<%=((User)request.getAttribute("user")).getXingming() %>" class="textbox textbox_295" placeholder="姓名"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">性别：</span>
        <input type="text" name="xingbie"   value="<%=((User)request.getAttribute("user")).getXingbie() %>" class="textbox textbox_295" placeholder="性别"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">年龄：</span>
        <input type="text"  name="nianling"   value="<%=((User)request.getAttribute("user")).getNianling() %>"  class="textbox textbox_295" placeholder="年龄"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">电话号码：</span>
        <input type="text"  name="dianhuahaoma"   value="<%=((User)request.getAttribute("user")).getDianhuahaoma() %>"  class="textbox textbox_295" placeholder="电话号码"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">电子邮件：</span>
        <input type="text" name="dianziyoujian"   value="<%=((User)request.getAttribute("user")).getDianziyoujian() %>"  class="textbox textbox_295" placeholder="电子邮件"/>
       </li>
